document.addEventListener("DOMContentLoaded", () => {
    ...
    const backButton = document.querySelectorAll('.back-btn'); // Atualizar para selecionar todos os botões de voltar
    ...
    options.forEach(option => {
        option.addEventListener("click", () => {
            // Remover a classe 'selected' e outras classes de todas as opções da tela atual
